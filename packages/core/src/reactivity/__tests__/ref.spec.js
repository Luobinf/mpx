import { ref, effect, reactive, isRef, toRef, toRefs, isReactive } from '../src/index';
...
describe('reactivity/ref', () => {
    ...
    it('should work like a normal property when nested in a reactive object', () => {
        ...
        const assertDummiesEqualTo = (val) => [dummy1, dummy2].forEach(dummy => expect(dummy).toBe(val));
    ...
    test.skip('toRefs should warn on plain object', () => {
        toRefs({});
        expect(`toRefs() expects a reactive object`).toHaveBeenWarned();
    });
    test.skip('toRefs should warn on plain array', () => {
        toRefs([]);
        expect(`toRefs() expects a reactive object`).toHaveBeenWarned();
    });
