...
describe('reactivity/shallowReadonly', () => {
    ...
    test.skip('should make root level properties readonly', () => {
    ...
    test.skip('should NOT make nested properties readonly', () => {
        const props = shallowReadonly({ n: { foo: 1 } });
        props.n.foo = 2;
    ...
    describe('collection/Map', () => {
        ...
        [Map, WeakMap].forEach(Collection => {
            test.skip('should make the map/weak-map readonly', () => {
                const key = {};
                const val = { foo: 1 };
                ...
                sroMap.set(key, {});
                expect(`Set operation on key "[object Object]" failed: target is readonly.`).toHaveBeenWarned();
            });
            test.skip('should not make nested values readonly', () => {
                const key = {};
                const val = { foo: 1 };
                const original = new Collection([[key, val]]);
                const sroMap = shallowReadonly(original);
        ...
        test.skip('should not make the value generated by the iterable method readonly', () => {
            const key = {};
            const val = { foo: 1 };
        ...
        test.skip('should not make the value generated by the forEach method readonly', () => {
            const val = { foo: 1 };
            const original = new Map([['key', val]]);
            const sroMap = shallowReadonly(original);
            sroMap.forEach(val => {
    ...
    describe('collection/Set', () => {
        test.skip('should make the set/weak-set readonly', () => {
            ;
            [Set, WeakSet].forEach(Collection => {
                ...
                sroSet.add({});
                expect(`Add operation on key "[object Object]" failed: target is readonly.`).toHaveBeenWarned();
            });
        });
        test.skip('should not make nested values readonly', () => {
            const obj = { foo: 1 };
