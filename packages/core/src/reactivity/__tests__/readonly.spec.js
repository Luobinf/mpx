...
describe('reactivity/readonly', () => {
    describe('Object', () => {
        ...
        it.skip('should not allow mutation', () => {
        ...
        it.skip('should not trigger effects', () => {
    ...
    maps.forEach((Collection) => {
        describe(Collection.name, () => {
            test.skip('should make nested values readonly', () => {
                const key1 = {};
                const key2 = {};
            ...
            test.skip('should not allow mutation & not trigger effect', () => {
    ...
    test.skip('should make ref readonly', () => {
    ...
    test.skip('calling readonly on computed should allow computed to set its private properties', () => {
        const r = ref(false);
        const c = computed(() => r.value);
        const rC = readonly(c);
        r.value = true;
        expect(rC.value).toBe(true);
        expect('Set operation on key "_dirty" failed: target is readonly.').not.toHaveBeenWarned();
        // @ts-expect-error - non-existent property
        rC.randomProperty = true;
        expect('Set operation on key "randomProperty" failed: target is readonly.').toHaveBeenWarned();
    });
    // #4986
